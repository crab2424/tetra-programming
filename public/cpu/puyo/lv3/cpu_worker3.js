// ─────────────────────────────────────────────
// cpu_worker3.js
// ぷよCPU lv3 用 Web Worker
// Wasm (cpu_wasm3.js / cpu_wasm3.wasm) を呼び出します。
// ─────────────────────────────────────────────
...
importScripts('cpu_wasm3.js?v=2'); // ★ v2.2.3 I: 窒息判定の追加で再ビルド
...
self.onmessage = function (e) {
    ...
    console.log(`⚡ Wasm Bitboard PuyoCPU3 (Depth:10) Calculated in: ${timeTaken} ms`);
